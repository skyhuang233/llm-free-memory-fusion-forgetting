...
DFM-Route, its query-aware retrieval extension, further demonstrates that the remaining temporal gap is a retrieval-routing problem rather than a rewriting problem: by routing temporal queries to anchor-based retrieval with date-unit recovery, temporal F1 improves 5.5$\times$ (0.055 to 0.298) without any LLM call at maintenance or retrieval time.
