...
DFM-Fusion achieves comparable multi-hop gains through offline maintenance (a one-time cost amortized over all future queries), while DFM-Route extends this at retrieval time with query-type-aware routing, recovering the temporal precision that query-agnostic deduplication cannot address (temporal F1 +58\%; Section~\ref{sec:exp-route}).
